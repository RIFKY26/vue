<template>
  <main class="login-container">
    <div class="left-panel" :style="{ '--bg-image': `url(${backgroundImage})` }">
      ...
      <h2 class="tagline">Mulailah bergabung sebagai shelter</h2>
    </div>

    <div class="right-panel">
      <div class="login-form-wrapper">
        <h1>Halo selamat datang!</h1>
        <p class="subtitle"><span class="action-text">Daftar</span>, dan bergabung bersama kami</p>
        ...
        <div class="links-section">
          <p class="register-link">Sudah punya akun? <router-link to="/login-shelter">Masuk</router-link></p>
        </div>
      </div>
    </div>
  </main>
